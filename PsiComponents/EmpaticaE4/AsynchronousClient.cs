...
namespace Test2
{
    public static class AsynchronousClient
    {
        ...
        private const string E4Name = "5BE2CC";
        ...
        public static void StartClient()
        {
            ...
            try
            {
                ...
                var msg = "device_connect " + E4Name;
                Send(client, msg + Environment.NewLine);
                SendDone.WaitOne();
                Receive(client);
                ReceiveDone.WaitOne();

                msg = "device_subscribe bvp ON" + Environment.NewLine;
                Send(client, msg);
                SendDone.WaitOne();
                Receive(client);
                ReceiveDone.WaitOne();

                msg = "device_subscribe gsr ON";
                Send(client, msg + Environment.NewLine);
                SendDone.WaitOne();
                Receive(client);
                ReceiveDone.WaitOne();

                msg = "device_subscribe tag ON";
                Send(client, msg + Environment.NewLine);
                SendDone.WaitOne();
                Receive(client);
                ReceiveDone.WaitOne();
